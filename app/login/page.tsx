      ...
      <div style={{ width: '100%', maxWidth: 380 }}>
        ...
        {tab === 'login' && (
          <form action={loginAction} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <input name="email"    type="text"    placeholder="帳號"   required autoComplete="off" style={inputStyle} />
            <input name="password" type="password" placeholder="密碼"     required autoComplete="off" style={inputStyle} />
            {loginState?.error && (
              <div style={{
